      ...
      <HeroSimple
       ...
       altText="Bischofsmütze Salzburger Land"
        ...
        <div class="mx-[var(--gap-xl)] mb-[var(--gap-xl)]">
         ...
         <h1 class="mb-[var(--gap-l)]">Datenschutz</h1>
            <h4>Grundlagen</h4>
            ...
            <p class="mb-[var(--gap-m)]">
              Beim Besuch unserer Website werden automatisch bestimmte technische Daten verarbeitet. Dazu gehören unter anderem die IP-Adresse, Browsertyp, Betriebssystem, Datum und Uhrzeit des Zugriffs sowie die aufgerufenen Seiten. Diese Daten sind für den Betrieb der Website technisch notwendig und dienen der Systemsicherheit sowie der Optimierung unseres Angebots. Rechtsgrundlage hierfür ist unser berechtigtes Interesse gemäß Art. 6 Abs. 1 lit. f DSGVO.
              Wenn Sie über ein Kontaktformular oder per E-Mail mit uns in Verbindung treten, verarbeiten wir die von Ihnen angegebenen personenbezogenen Daten ausschließlich zur Bearbeitung Ihrer Anfrage. Die Daten werden nur so lange gespeichert, wie es für die Bearbeitung notwendig ist.
              Es werden keine Tracking-Tools, keine Analyse-Dienste und keine Cookies zu Marketing- oder Statistikzwecken eingesetzt.
              Bei Verdacht einer rechtswidrigen Handlung werden die Zugriffsdaten zur Beweissicherung ausgewertet. 
              Für den Verlust von Daten oder den Zugriff Dritter auf Ihre Daten übernehmen wir keine Haftung. 
              Die Rechtsgrundlagen für diese Datenverarbeitungen sind Ihre Einwilligung, unsere vorvertraglichen und vertraglichen Verpflichtungen Ihnen gegenüber, unsere berechtigten Interessen und rechtlichen Verpflichtungen aller Art und § 96 TKG. Der Inhalt unserer Website wurde sorgfältig erstellt und mehrfach kontrolliert, für die Aktualität, Richtigkeit und Vollständigkeit der bereitgestellten Informationen übernehmen wir jedoch keine Haftung. Ansprüche auf Schadenersatz wegen Nutzung oder Nichtnutzung der Informationen bzw. durch die Nutzung fehlerhafter oder unvollständiger Informationen, sind ausgeschlossen. Alle Angebote sind freibleibend und unverbindlich. Wir behalten uns das Recht vor, das Angebot oder Teile davon ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die Veröffentlichung der Website zeitweise oder endgültig einzustellen. Der Inhalt und die Programmierung unserer Website sind Urheber- und leistungsschutzrechtlich geschützt. Jede Vervielfältigung – auch auszugsweise – und öffentliche Wiedergabe, insbesondere das Kopieren von Texten, Grafiken und Fotos, ist ohne unsere vorhergehende schriftliche Zustimmung verboten.
            </p>

            <h4>Newsletter</h4>
            <p class="mb-[var(--gap-m)]">Wir verschicken keine Newsletter.</p>
            
            <h4>Übermittlung an Dritte / Verpflichtungen von Auftragsverarbeitern</h4>
            <p class="mb-[var(--gap-m)]">
              Ihre personenbezogenen Daten werden von uns unter Umständen innerhalb des Betriebes unter Berücksichtigung der zulässigen Verwendungszwecke, an Auftragsverarbeiter, sowie, an Dritte, die für die Erbringung der von Ihnen gewünschten Dienstleistungen beigezogen werden müssen, die sich alle uns gegenüber zur Einhaltung der geltenden Datenschutz-Standards verpflichtet haben,
            ...
            <p class="mb-[var(--gap-m)]">
              Wir verwenden auf unserer Website keine Cookies, die nicht technisch notwendig sind. Es werden keine Tracking- oder Analyse-Tools, keine Social-Media-Plugins und keine externen Inhalte wie YouTube oder Google Maps eingebunden.              
            </p>
