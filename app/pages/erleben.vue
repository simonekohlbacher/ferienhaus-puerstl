<template>
  <Hero
    title="Zahlreiche Erlebnisse"
    description="..direkt vor der Haustüre"
    backgroundImage="/img/wandern-reiteralm.jpg"
    altText="Wandern Reiteralm"
    :opacity="0.3"
  ...
  <div class="text-center max-w-[70vw] mx-auto mb-[var(--gap-xl)]">
    ...
    <p class="[font-size:var(--font-size-h4)]">
      Die Ferienregion Schladming-Dachstein und die Salzburger Welt bieten eine
      beeindruckende Vielfalt an Natur, Sport und Kultur. Ob Wandern und
      Mountainbiken im Sommer, Skifahren auf bestens präparierten Pisten im
      Winter oder gemütliche Ausflüge zu Almen, Seen und charmanten Orten – hier
      findet jeder das passende Erlebnis. Unser Ferienhaus ist der ideale
      Ausgangspunkt, um all diese Abenteuer bequem zu erreichen und gleichzeitig
      die Ruhe und Schönheit der Berge zu genießen.
    </p>
  ...
  <div
    class="flex flex-col md:flex-row justify-center gap-[var(--gap-m)] mb-[var(--gap-xl)]"
  >
    <img
    ...
    <div class="relative">
      <img
        src="/img/kulinarik-krapfen.jpg"
        alt="Alm Kulinarik"
        class="w-full md:w-[30vw] hover:grayscale transition duration-800"
      />
      <span
        class="absolute bottom-2 left-2 [font-size:var(--font-size-small)] text-[var(--color-white)] opacity-100"
        >© Schladming-Dachstein | Peter Burgstaller</span
      >
    </div>
  </div>

  <ImageText
    headline="Der Bergsommer wartet auf dich!"
